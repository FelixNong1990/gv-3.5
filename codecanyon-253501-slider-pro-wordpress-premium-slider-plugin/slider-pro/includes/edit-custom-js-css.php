...
<?php if (is_writable(WP_PLUGIN_DIR . '/' . $sliderpro_assets_dir . '/custom')) { ?>
...
<?php } else { ?>
	<div class="custom-not-writable">
		Note: You need to make the <i><?php echo $sliderpro_assets_dir; ?>/custom</i> folder writable before you can add custom CSS and Javascript.
