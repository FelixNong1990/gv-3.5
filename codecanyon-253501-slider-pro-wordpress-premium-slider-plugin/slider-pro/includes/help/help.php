...
<section id="updating">
	...
	<div class="row">
		<div class="span3">
			...
			<p>Automatic updates were introduced in version 3.9. In order to activate automatic updates, first, you need to add your purchasing code in the Slider PRO -> Plugin Options page. The purchase code can be found on CodeCanyon.net</p>
			<p>Then, you need to move some folders that contain custom assets in a separate folder, outside the main plugin folder, in order to avoid having these custom files removed. This can be done automatically, by the plugin, or, if the folder permissions on your server don't allow the plugin to create the folder automatically, you will need to create them manually.</p>
			<p>The folders that need to be moved are 'custom', 'skins' and 'xml' from 'wp-content/plugins/slider-pro' and then need to be moved to 'wp-content/slider-pro-assets'.</p>
			<p>If you're updating from a version older than 3.9, please see the instructions below.</p>
		</div>
		<div class="span9">
			<img src="<?php echo plugins_url('/slider-pro/includes/help/'); ?>assets/img/find-purchase-code.png">
		</div>
	</div>
...
.my-custom-skin .slide-wrapper {
	...
	<div class="alert alert-info"> <strong>NOTE:</strong> In order to edit the skins or create custom skins, the 'skins' folder (/wp-content/plugins/slider-pro-assets/skins/slider/) and the 'custom' folder (/wp-content/plugins/slider-pro-assets/custom) need to be writeable. On some servers this means that the folder has to have the permission set to 755 but on other servers it has to have the permission set to 777. I recommed to check with your webhost what would be the best permission setting for making the folder writeable.</div>
...
<section id="dynamic">
	...
	<br />
	<br />
	<p>Insert the post title, the date of the post and the excerpt of the post in the slide's layers.</p>
...
<section id="miscellaneous">
	...
	<div class="row">
    	<div class="span3">
			<p>In general, you will add videos inside the layers, either using the slider's video shortcodes or raw HTML code. Also, instead of typing the video shortcode you can use the 'Insert Video' menu below the layers' editing area.</p>
...
&lt;/div&gt;
	...
	<h3 id="miscellaneous4">4. Responsive layers</h3>
	<div class="row">
		<div class="span12">
			<p>If you want the inner layers to be responsive as well, you will need to set the layer's width and/or height to percentage values (i.e. 40%) instead of fixed values.</p>

			<p>Also, the text size can be controlled using media queries:</p>
...
@media (max-width:480px) {
    .advanced-slider .layer {
        font-size: 8px;
			...
			<p>However, in responsive design you shouldn’t necessarily make the text smaller because you’re making it hard to read and the user will need to zoom-in. In my opinion, it’s better to just hide certain portions of the text and only leave some headline visible. For example, let’s you have this text inside a layer:</p>
...
&lt;p class="description"&gt;Some description for the current slide&lt;/p&gt;
			...
			<p>You could hide the description for smaller screens and only head the headline visible:</p>
...
@media (max-width:480px) {
	...
	<h3 id="miscellaneous5">5. Responsive videos</h3>
	<div class="row">
		<div class="span12">
			<p>The videos you insert inside the slider, or any other HTML content, will not automatically be responsive. You will need to set its size to percentage values, like 100% in order to make it so.</p>
			
<pre class="prettyprint linenums">
[slider_pro_video type="youtube" id="msIjWthwWwI" params="rel=1&showinfo=0" width="100%" height="100%"]
</pre>
			
			<p>Also, you will need to make sure the video's container is responsive as well, so if you insert the video in a layer, make sure the layer's Width and Height options, from the layer's settings panel, is set to percentage values as well.</p>
		</div>
	</div>

	<hr />	

	<h3 id="miscellaneous6">6. Positioning the thumbnail scroller</h3>
	<div class="row">
		<div class="span12">
			<p>The orientation of the thumbnail scroller can be set to 'Horizontal' or 'Vertical'. When the orientation is horizontal, the scroller is positioned below the slider, and when the orientation is vertical, the scroller is positioned to the right of the slider. If you want to position the scroller above or to the left of slider, you will need to use some custom CSS code.</p>
...
.my-slider .slider-main {
    padding-top: 100px;
			...
			<h5>2. Thumbnail scroller to the left of the slider</h5>
...
jQuery(document).ready(function($) {
	...
	<div class="alert alert-info"> <strong>NOTE:</strong> In order to add custom JavaScript code, the 'custom' folder (/wp-content/plugins/slider-pro-assets/custom) needs to be writeable. On some servers this means that the folder has to have the permission set to 755 but on other servers it has to have the permission set to 777. I recommed to check with your webhost what would be the best permission setting for making the folder writeable.</div>
...
AddType video/x-m4v .m4v
    ...
    <p>It can happen if the xml folder (/wp-content/plugins/slider-pro-assets/xml) is not writeable. In order to make it writeable you might have to set its permission to 777. I recommed to check with your webhost what would be the best permission setting for making the folder writeable. If you still get an error after this edit, please contact your hosting provider and ask them if the XML-DOM library is installed. This library is used by the plugin to save each slider in an XML format, which allows you to export and import sliders. You can disable this feature, if you want, from within the Slider PRO -> Plugin Options page.</p>
	...
	<p>It can happen if the 'skins/slider' folder (/wp-content/plugins/slider-pro-assets/skins/slider) or  the'custom' folder (/wp-content/plugins/slider-pro-assets/custom) are not writeable. In order to make them writeable you might neet to change their permission to 777. I recommed to check with your webhost what would be the best permission setting for making the folder writeable.</p>
	...
	<p>The export file, which is an XML representation of the slider, is created when a new slider is created or when it's updated. The file will be created only if the 'xml' folder (/wp-content/plugins/slider-pro-assets/xml) is writable. In order to make it writeable you might neet to change the permission to 777. I recommed to check with your webhost what would be the best permission setting for making the folder writeable.</p>
	...
	<h4 id="troubleshooting17">17. Slider doesn't work inside other shortcodes</h4>
	
	<p>Try to set the slider's 'Include Skin' option (from the 'General' panel) to true.</p>
...
<section id="changelog">
	...
	<h3>Files added or modified in version 3.9.2</h3>
	<ul class="custom-list">
		<li>slider-pro/slider-pro.php</li>
		<li><b>slider-pro/includes &#9660;</b></li>
		<li>slider-pro/includes/flickr/phpFlickr.php</li>
	</ul>

	<h3>Files added or modified in version 3.9.1</h3>
	<ul class="custom-list">
		<li>slider-pro/slider-pro.php</li>
		<li><b>slider-pro/includes &#9660;</b></li>
		...
		<li>slider-pro/js/editor-plugin-old.js</li>
	</ul>
	
	<h3>Files added or modified in version 3.9</h3>
	<ul class="custom-list">
		<li>slider-pro/slider-pro.php</li>
		<li><b>slider-pro/includes &#9660;</b></li>
		...
		<li>slider-pro/includes/slider-uninstall.php</li>
	...
	<h3>Files added or modified in version 3.8</h3>
	<ul class="custom-list">
		<li>slider-pro/slider-pro.php</li>
		<li><b>slider-pro/includes &#9660;</b></li>
		<li>slider-pro/includes/sliders.php</li>
	...
	<h3>Files added or modified in version 3.7</h3>
	<ul class="custom-list">
		<li>slider-pro/slider-pro.php</li>
		<li><b>slider-pro/includes &#9660;</b></li>
		<li>slider-pro/includes/help/help.php</li>
		<li>slider-pro/includes/timthumb/timthumb.php</li>
		<li><b>slider-pro/js &#9660;</b></li>
		<li>slider-pro/js/slider-pro-admin.js</li>
		<li>slider-pro/js/slider/jquery.advancedSlider.min.js</li>
		<li>slider-pro/js/slider/dev/jquery.advancedSlider.js</li>
