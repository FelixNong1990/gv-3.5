<div class="wrap slider-pro">
    ...
    <?php wp_nonce_field('skin-editor-update', 'skin-editor-nonce'); ?>
        ...
        <div class="skin-editor-sidebar">
            ...
            <?php if (is_writable(WP_PLUGIN_DIR . '/' . $sliderpro_assets_dir . '/skins/slider')) { ?>
            ...
            <?php if (!is_writable(WP_PLUGIN_DIR . '/' . $sliderpro_assets_dir . '/skins/slider')) { ?>                
                <div class="skins-not-writable">
                    Note: You need to make the <i><?php echo $sliderpro_assets_dir; ?>/skins/slider</i> folder writable before you can replicate a skin.
