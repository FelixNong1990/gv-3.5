<div class="wrap slider-pro<?php echo floatval(get_bloginfo('version')) >= 3.8 ? ' flat-design' : ''; ?>">
			...
			echo '<tr>'.
					...
					'<td>' .
						...
						if (get_option('slider_pro_generate_xml_file')) {
							...
							$link;
							$file = WP_PLUGIN_DIR . '/' . $sliderpro_assets_dir . '/xml/' . $name;
							
							if (file_exists($file))
								$link = '<a href="' . plugins_url('/slider-pro/includes/export.php?name=' . $name . '&loc=' . $sliderpro_assets_dir) . '">' . __('Export', 'slider_pro') . '</a>';
							else
