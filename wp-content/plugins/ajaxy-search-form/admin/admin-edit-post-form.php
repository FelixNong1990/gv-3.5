				...
				<div class="inside">
					<div class="submitbox">	
						<div class="misc-pub-section" >
							<p><?php echo do_shortcode('[ajaxy-selective-search label="'.sprintf(_('Search %s to exclude'),$post_type->label).' post_types="'.$post_type->name.'" name="sf_exclude_post" show_category="0" value="{ID}"]'); ?></p>
