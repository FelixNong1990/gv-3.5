...
$sliderpro_properties_help = array('width' => __('The total width of the slider. Can be set in percentages if the \'%\' symbol is used or in pixels if only a number is used. If the slider is set to be responsive, the specified value will represent the maximum width.', 'slider_pro') .'<br/><br/><b>'. 
											  __('Setting Name: ', 'slider_pro') .'</b><i> width </i>', 
									
									'height' => __('The total height of the slider. Can be set in percentages if the \'%\' symbol is used or in pixels if only a number is used. If the slider is set to be responsive, the specified value will represent the maximum height.', 'slider_pro') .'<br/><br/><b>'. 
												__('Setting Name: ', 'slider_pro') .'</b><i> height </i>', 
									
									'responsive' => __('Sets the slider to be responsive. The values specified for the Width and Height options will represent the maximum width and height for the slider.', 'slider_pro') .'<br/><br/><b>'. 
													__('Setting Name: ', 'slider_pro') .'</b><i> responsive </i>', 

									'aspect_ratio' => __('Sets the aspect ratio of the slider. The aspect ratio defines the ratio between the width and the height of the slider. A ratio of 2 will make the slider width 2 times larger than the height. <br/>The default value, -1, indicates that an aspect ratio will not be applied to the slider.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'preload_nearby_images' => __('Indicates whether the images located nearby the currently opened image will be preloaded. This will happen only if the nearby images are set to lazy load.', 'slider_pro') . '<br/><br/><b>'. 
									...
									'slideshow_direction' => __('Sets the direction of the slideshow. If \'next\' was specified the slideshow will advance to the next slide, if \'previous\' the slideshow will open the previous slide.', 'slider_pro') . '<br/><br/><b>'. 
									...
									'lightbox' => __('Enables the lightbox for all slides. This is an alternative for enabling the Lightbox option for each individual slide.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'lightbox_icon' => __('Indicate whether an overlay icon will appear when a slide or thumbnail has a lightbox attached to it.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'thumbnail_lightbox_icon' => __('Indicates whether a lightbox icon will be displayed on the thumbnail when the corresponding slide has a lightbox attached to it.' . '<br/><b>'. 'Not to be confused with the possibility of having the icon displayed when a lightbox is attached to the thumbnail itself. For this, only the \'Lightbox Icon\' option needs to be enabled.', 'slider_pro') .'<br/><br/><b>'. 
														  		 __('Setting Name: ', 'slider_pro') .'</b><i> thumbnail_lightbox_icon </i>', 
																	 
									'thumbnail_lightbox_icon_toggle' => __('Indicates whether the thumbnail lightbox icon will fade in/out on hover. This option is used only when the lightbox icon is enabled for the thumbnails that correspond to slides that have a lightbox attached to them.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'override_transition' => __('Indicates whether it\'s permitted to start a new transition while another one is in progress.', 'slider_pro') .'<br/><br/><b>'.
									...
									'css3_transitions' => __('Indicates whether the transition effects  will use the hardware accelerated CSS3 transition capabilities.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'initial_effect' => __('Indicates whether the initial slide will have a transition effect. If set to false, the first slide will initially appear instantly.', 'slider_pro') .'<br/><br/><b>'. 
														__('Setting Name: ', 'slider_pro') .'</b><i> initial_effect </i>', 
									
									'html_during_transition' => __('Indicates whether specified HTML content will be displayed while the transition is in progress. A transition which displayes HTML will be slower.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'slide_loop' => __('Indicates whether the slides will run in a loop when the \'auto H\' or \'auto V\' directions are used.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'swipe_orientation' => __('Sets the orientation of the slides and the direction for which the swipe gestures will work.', 'slider_pro') .'<br/><br/><b>'.
														   __('Available Values: ', 'slider_pro') .'</b><i>Horizontal, Vertical</i>' . '<br/><br/><b>'. 
														   __('Setting Name: ', 'slider_pro') .'</b><i> swipe_orientation </i>', 
														
									'swipe_threshold' => __('Sets the minimum amount that the slides need to be dragged in order to navigate to the new slide.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'slice_start_ratio' => __('Sets the actual distance between the starting and ending point for the \'slide\' animation. The actual distance will be determined by multiplying the slice\'s width/height to the \'sliceStartRatio\' property.', 'slider_pro') .'<br/><br/><b>'. 
														   __('Setting Name: ', 'slider_pro') .'</b><i> slice_start_ratio </i>', 
									
									'slice_fade' => __('Indicates whether the slice will start as transparent and fade in when \'scale\', \'width\' or \'height\' or \'slide\' effects are used.', 'slider_pro') .'<br/><br/><b>'. 
													__('Setting Name: ', 'slider_pro') .'</b><i> slice_fade </i>', 
									
									'slide_mask' => __('Indicates whether the slices will be visible outside the slide area. This effect is relevant when the \'slide\' effect is used.', 'slider_pro') .'<br/><br/><b>'.
													__('Setting Name: ', 'slider_pro') .'</b><i> slide_mask </i>', 
									
									'keyboard_navigation' => __('Indicates whether keyboard navigation will be enabled. This options allows navigation through the slides by using the left and right arrow keyboard keys. Also if you have a link attached to a slide, it\' possible to open that link by pressing the \'Enter\' key.', 'slider_pro') .'<br/><br/><b>'. 
													  		 __('Setting Name: ', 'slider_pro') .'</b><i> keyboard_navigation </i>', 
															 
									'keyboard_navigation_on_focus_only' => __('Indicates whether keyboard navigation will be enabled only when the slider has focus.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'slide_buttons_center' => __('Indicates whether the navigation buttons will be centered horizontally within the main buttons container. If false, you can set a custom position for the buttons from within the CSS file.', 'slider_pro') .'<br/><br/><b>'. 
															  __('Setting Name: ', 'slider_pro') .'</b><i> slide_buttons_center </i>', 
									
									'slide_buttons_container_center' => __('Indicates whether the navigation buttons container will be centered horizontally. If false, you can set a custom position for the container from within the CSS file.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'auto_toggle' => __('Indicates whether the navigation controls (slide arrows, slide buttons, slideshow controls) will automatically hide if the mouse pointer doesn\'t move for a certain time interval, defined by the autoToggleDelay property. The controls will automatically hide only if the control\'s toggle property (for example, slideArrowsToggle) was set to true.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'thumbnail_type' => __('Indicates the way in which the thumbnails will be displayed. If \'tooltip\' is used the thumbnails will fade in on top of the navigation buttons when you roll over	them. If \'scroller\' is used the thumbnails will appear inside the thumbnail scroller and it \'tooltipAndScroller\' is used the thumbnails will appear both as tooltips and inside the thumbnail scroller.', 'slider_pro') .'<br/><br/><b>'.
														__('Available Values: ', 'slider_pro') .'</b> <br/>
									...
									'thumbnail_scroller_responsive' => __('Indicates whether the thumbnail scroller will be responsive as well if the slider\'s size is set in percentages.', 'slider_pro') .'<br/><br/><b>'. 
																	   __('Setting Name: ', 'slider_pro') .'</b><i> thumbnail_scroller_responsive </i>', 
									
									'thumbnail_scroller_overlay' => __('Indicates whether the thumbnail scroller will be displayed over the slider, nstead of outside the slider.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'minimum_visible_thumbnails' => __('Sets the minimum number of thumbnails per page. This property is useful in a responsive layout.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'thumbnail_layers' => __('Indicates the number of layers that will be used. Layers can represent either rows, when the thumbnail orientation is set to \'horizontal\', or columns, when the thumbnail orientation is set to \'vertical\'. In order to use the maximum amount of layers allowed, set this option to -1.', 'slider_pro') .'<br/><br/><b>'. 
														  __('Setting Name: ', 'slider_pro') .'</b><i> thumbnail_layers </i>', 
															   
									'thumbnail_tooltip' => __('Indicates whether the tooltip will be displayed for those thumbnails for which the tooltip content was specified.', 'slider_pro') .'<br/><br/><b>'. 
														   __('Setting Name: ', 'slider_pro') .'</b><i> thumbnail_tooltip </i>', 
									
									'thumbnail_arrows' => __('Indicates whether the navigation thumbnails will have arrows for navigating through thumbnail pages.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'thumbnail_scroll_duration' => __('Sets the duration of the scrolling animation when the thumbnail arrows or thumbnail buttons are used for scrolling.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'thumbnail_buttons' => __('Indicates whether the navigation thumbnails will have buttons (bullets) for navigating through thumbnail pages.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'scrollbar_arrow_scroll_amount' => __('Sets the amount, in pixels, by which the thumbnails will be scrolled when one of the scrollbar\'s arrows is clicked.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'thumbnail_mouse_wheel_reverse' => __('Indicates whether the thumbnails will be scrolled in the opposite direction when mouse wheel scrolling is used.', 'slider_pro') .'<br/><br/><b>'.
																	   __('Setting Name: ', 'slider_pro') .'</b><i> thumbnail_mouse_wheel_reverse </i>', 
									
									'thumbnail_caption' => __('Indicates whether the thumbnails will display a caption. The thumbnail\'s caption needs to be specified in the thumbnail\'s "Alt" field.', 'slider_pro') .'<br/><br/><b>'. 
														   __('Setting Name: ', 'slider_pro') .'</b><i> thumbnail_caption </i>', 

									'thumbnail_caption_position' => __('Sets the position of the caption inside the thumbnail. Can be set to \'top\' or \'bottom\'.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'caption_size' => __('Sets the width or height of the caption when the \'Caption Position\' option is set to \'Top\', \'Bottom\', \'Left\', \'Right\'', 'slider_pro') .'<br/><br/><b>'. 
									...
									'image_alt' => __('The ALT text for the slide\'s image. Will be used as a lightbox title if a lightbox was created for the slide.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'thumbnail_alt' => __('The ALT text for the thumbnail image. Can be used either to specify a tooltip or the lightbox title if a lightbox was created for the thumbnail.', 'slider_pro') .'<br/><br/><b>'. 
													   __('Setting Name: ', 'slider_pro') .'</b><i> thumbnail_alt </i>', 
									
									'thumbnail_title' => __('The title text for the current slide\'s thumbnail.	Will also be used as a thumbnail caption. The caption will be displayed only if the Thumbnails Type is set to \'scroller\' or \'tooltipAndScroller\'.', 'slider_pro') .'<br/><br/><b>'. 
														 __('Setting Name: ', 'slider_pro') .'</b><i> thumbnail_title </i>', 
									
									'slide_link_path' => __('Sets a link for the slide image. The link will be opened in a lightbox if the \'Lightbox\' checkbox is checked.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'slide_link_title' => __('Sets the title of the link. It will be used to specify the lightbox description if the link will be opened in a lightbox.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'thumbnail_link_path' => __('Sets a link for the thumbnail image. The link will be opened in a lightbox if the \'Lightbox\' checkbox is checked.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'thumbnail_link_title' => __('Sets the title of the link. It will be used to specify the lightbox description if the link will be opened in a lightbox.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'slide_resizing_crop' => __('Sets the cropping type of the resized slide image.', 'slider_pro') .'<br/><br/><b>'. 
														     __('Available Values: </b> <br/> 0 - resize to fit specified dimensions. <br/> 1 - resize and crop to best fit the specified dimensions. <br/> 2 - resize proportionally to fit entire image into specified dimenstions, and add borders if required. <br/> 3 - resize proportionally, adjusting the size of the scaled image so there are no borders.', 'slider_pro') . '<br/><br/><b>'. 
															 __('Setting Name: ', 'slider_pro') .'</b><i> slide_resizing_crop </i>', 
																
									'slide_resizing_quality' => __('Sets the quality of the resized slide image. 100 is the maximum value but most of the times 95 is sufficient.', 'slider_pro') . '<br/><br/><b>'. 
																__('Setting Name: ', 'slider_pro') .'</b><i> slide_resizing_quality </i>', 
									
									'slide_resizing_width' => __('Sets the width to which the slide image will be resized. If the value is set to \'auto\', the image\'s width will be set to the total width of the slider specified in the \'General\' panel. ', 'slider_pro') . '<br/><br/><b>'. 
															  __('Setting Name: ', 'slider_pro') .'</b><i> slide_resizing_width </i>', 
									
									'slide_resizing_height' => __('Sets the height to which the slide image will be resized. If the value is set to \'auto\', the image\'s height will be set to the total height of the slider specified in the \'General\' panel. ', 'slider_pro') . '<br/><br/><b>'. 
																__('Setting Name: ', 'slider_pro') .'</b><i> reach_video_action </i>', 
									
									'thumbnail_resizing_resize' => __('Indicates whether the thumbnail images will be resized to the specified width and height for the thumbnail.', 'slider_pro') . '<br/><br/><b>'. 
									...
									'thumbnail_resizing_quality' => __('Sets the quality of the resized thumbnail image. 100 is the maximum value but most of the times 95 is sufficient.', 'slider_pro') . '<br/><br/><b>'. 
									...
									'slide_type' => __('Indicates the type of the current slide. A slide can be static or dynamic. A dynamic slide can also be of 2 types: a slide that fetches data from posts, pages and custom posts types or a slide that fetches data from a post\'s gallery.', 'slider_pro') . '<br/><br/><b>'. 
								    ...
								    'dynamic_posts_maximum' => __('Sets the maximum number of posts that will be queried. If you want to query all posts, set the option to -1.', 'slider_pro') . '<br/><br/><b>'. 
									...
									'dynamic_gallery_post' => __('Sets the ID of the post from where the images will be loaded. If -1 is used, the images will be loaded from the post where the slider is inserted.', 'slider_pro') . '<br/><br/><b>'. 
															  __('Setting Name: ', 'slider_pro') .'</b><i> dynamic_gallery_post </i>', 
									
									'dynamic_gallery_maximum' => __('Sets the maximum number of images that will be loaded. If -1 is used, all the images from the post\'s gallery will be loaded.', 'slider_pro') . '<br/><br/><b>'. 
									...
									'dynamic_gallery_type' => __('Indicates whether the slider will load images attached/uploaded to the post, or images from a gallery that was added to that post.', 'slider_pro') . '<br/><br/><b>'. 
									...
									'layer_transition' => __('Sets the direction of the layer\'s slide in transition. If \'Left\' is used, the layer will slide in from right to left. If \'Up\' is used, the layer will slide in from bottom to top. ', 'slider_pro') . '<br/><br/><b>'. 
									...
									'layer_horizontal' => __('Sets the horizontal position of the layer. Can be set to left, center, right, a percentage value or a fixed value. This value will be relative to reference point set for the data-position attribute.', 'slider_pro') . '<br/><br/><b>'. 
														  __('Setting Name: ', 'slider_pro') .'</b><i> layer_horizontal </i>',
									
									'layer_vertical' => __('Sets the vertical position of the layer. Can be set to top, center, bottom, a percentage value or a fixed value. This value will be relative to reference point set for the data-position attribute.', 'slider_pro') . '<br/><br/><b>'. 
