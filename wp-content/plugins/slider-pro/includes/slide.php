<div class="postbox slidebox">
	...
	<div class="inside">
        <div class="slide-tabs">
            ...
            <div id="image-<?php echo $counter;?>" class="panel-tab-content clearfix">
						...
						<tbody>
							...
							<tr>
								...
								<td><input name="slide[<?php echo $counter;?>][content][alt]" type="text" 
										   value="<?php echo sliderpro_get_slide_content($slide_content, 'alt', true); ?>" class="alt" /></td>
							</tr>
							
							<tr>
								<td><label title="image_title"><?php _e('Title', 'slider_pro'); ?></label></td>
								<td><input name="slide[<?php echo $counter;?>][content][title]" type="text" 
										   value="<?php echo sliderpro_get_slide_content($slide_content, 'title', true); ?>" class="title" /></td>
							</tr>
						</tbody>
                    </table>
                </div>
            ...
            <div id="thumbnail-<?php echo $counter;?>" class="panel-tab-content clearfix">
							...
							<tbody>
								...
								<tr>
									...
									<td><input name="slide[<?php echo $counter;?>][content][thumbnail_alt]" type="text" 
											   value="<?php echo sliderpro_get_slide_content($slide_content, 'thumbnail_alt', true); ?>" class="alt"/></td>
								</tr>
								...
								<tr>
									...
									<td><input name="slide[<?php echo $counter;?>][content][thumbnail_title]" type="text" 
											   value="<?php echo sliderpro_get_slide_content($slide_content, 'thumbnail_title', true); ?>" class="title"/></td>
								</tr>
							</tbody>
	                    </table>
	                </div>
			...
			<div id="layers-<?php echo $counter;?>" class="panel-tab-content layer-editor">
            ...
            <div id="settings-<?php echo $counter;?>" class="panel-tab-content">
			...
			<div id="slide-type-<?php echo $counter;?>" class="panel-tab-content">
