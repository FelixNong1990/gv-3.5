<?php
	...
	?>
			<div class="userpro-admin-head">
				<div class="userpro-admin-left">
					...
					<span class="userpro-admin-span"><?php if (get_option('userpro_activated')) { _e('Thank you for activating UserPro!','userpro'); } else { _e('This copy is fully licensed and puchase by HaselBiscuit.','userpro'); } ?></span>
				</div>
	...
	/* Get skin list  purchase by HaselBiscuit*/
	...
	/* Show builtin mail vars  purchase by HaselBiscuit*/
	...
	/* Count fields purchase by HaselBiscuit */
	...
	/**
	List all fields purchase by HaselBiscuit
	**/
