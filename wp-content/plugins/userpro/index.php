...
Description: The ultimate user profiles and memberships plugin for WordPress. Purchased by HaselBiscuit and Only in Best Black Hat Forum
Version: 1.0.90
Author: Deluxe Themes. Purchased by HaselBiscuit and Only in Best Black Hat Forum
...
define('userpro_path',plugin_dir_path(__FILE__ ));
	...
	/* administration purchase by HaselBiscuit */
	if (is_admin()){
